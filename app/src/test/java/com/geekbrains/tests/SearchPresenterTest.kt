...
class SearchPresenterTest {
    ...
    //при вызове handleGitHubError должны запускаеться displayLoading и displayError, если до него был вызван onAttach
    @Test
    ...
    //при вызове handleGitHubError не запускается displayLoading и displayError, если handleGitHubError вызван после onAttach
    @Test
    ...
    //при вызове handleGitHubError не запускается displayLoading и displayError, если handleGitHubError вызван после onDetach
    @Test
